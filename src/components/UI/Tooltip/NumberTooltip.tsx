...
import { convertToElId as convertToElementId } from '../../../modules/Util';

interface NumberTooltipProperties {
  number: number;
  id: string;
}

export default function (properties: NumberTooltipProperties): JSX.Element {
  const dir = i18n.dir();
