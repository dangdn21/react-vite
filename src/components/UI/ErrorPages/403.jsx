...
export default function (properties) {
  ...
  return (
    <div {...properties} className={`error-403 h-full pt-50 ${clsx(properties.className)}`}>
      <Particles id="tsparticles" options={particles} />
      <div className="z-1">
        <svg className="mx-auto" xmlns="http://www.w3.org/2000/svg" id="robot-error" viewBox="0 0 260 118.9">
          <defs>
